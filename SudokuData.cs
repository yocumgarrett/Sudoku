...
{
    static string[] hard_titles = new string[9] {
        "3per",
        "02-Feb-2022",
        "Diagonal Pi",
        "Rows 29",
    ...
    public static List<SudokuData.SudokuBoardData> getData()
    {
        ...
        // It's Not One
        // Hard, uses conjugate pairs, 5 stars
        data.Add(new SudokuData.SudokuBoardData(
            hard_titles[8], 5f,

            new int[81] {0, 0, 5, 9, 0, 0, 0, 0, 0,
                         4, 0, 0, 0, 1, 0, 9, 0, 0,
                         8, 9, 0, 0, 0, 0, 0, 2, 3,
                         0, 0, 6, 3, 4, 5, 7, 8, 0,
                         0, 0, 0, 0, 9, 0, 0, 0, 0,
